...
public class Robot extends TimedRobot {
  ...
  final double joystickXDampen = 0.8;
  final double joystickYDampen = 1.0;
  public boolean turn = false;
  public double elevatorEncoderDestination = 0;
  public double wristEncoderDestination = WristMechanism.wristUp;
  ...
  public void teleopPeriodic() {
    ...
    if(oi.isWristDown()){
      // wristMechanism.moveWristDown();
      wristEncoderDestination = WristMechanism.wristDown;
    }
    else if(oi.isWristOut()){
      // wristMechanism.moveWristOut();
      wristEncoderDestination = WristMechanism.wristOut;
    }
    else if(oi.isWristUp()){
      // wristMechanism.moveWristUp();
      wristEncoderDestination = WristMechanism.wristUp;
    }

    wristMechanism.setEncoderDestination(wristEncoderDestination);
    ...
    SmartDashboard.putNumber("Wrist Encoder Count:   ", wristMechanism.getEncoderCount());
